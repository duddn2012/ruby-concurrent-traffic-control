...
ActiveRecord::Schema[8.0].define(version: 2025_07_26_043559) do
  ...
  create_table "user_point_histories", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["event_id"], name: "index_user_point_histories_on_event_id"
  ...
  add_foreign_key "user_point_histories", "events"
